...
HD_PWD='C:/Users/18999/Documents/PG work/BuanGu_230825701_ICDLab2024/Prime_Checker_custom_mod2/Prime_Checker.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PrimeChecker.vds -m64 -mode batch -messageDb vivado.pb -notrace -source PrimeChecker.tcl
