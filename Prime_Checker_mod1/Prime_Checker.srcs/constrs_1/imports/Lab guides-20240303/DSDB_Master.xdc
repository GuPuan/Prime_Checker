...
# LEDs
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { number_leds[0] }]; #IO_L12P_T1_MRCC_13 Sch=led[0]
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { number_leds[1] }]; #IO_L12N_T1_MRCC_13 Sch=led[1]
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33 } [get_ports { number_leds[2] }]; #IO_L23P_T3_13 Sch=led[2]
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { number_leds[3] }]; #IO_L23N_T3_13 Sch=led[3]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { guess_result_led }]; #IO_L1P_T0_13 Sch=led[4]
set_property -dict { PACKAGE_PIN W12   IOSTANDARD LVCMOS33 } [get_ports { prime_result_led }]; #IO_L4N_T0_13 Sch=led[5]
set_property -dict { PACKAGE_PIN W11   IOSTANDARD LVCMOS33 } [get_ports {user_guess_led }]; #IO_L3P_T0_DQS_13 Sch=led[6]
...
# Switches
set_property -dict { PACKAGE_PIN T6    IOSTANDARD LVCMOS33 } [get_ports { sliders[0] }]; #IO_L19N_T3_VREF_13 Sch=sw[0]
set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { sliders[1] }]; #IO_L22N_T3_13 Sch=sw[1]
set_property -dict { PACKAGE_PIN T4    IOSTANDARD LVCMOS33 } [get_ports { sliders[2] }]; #IO_L20P_T3_13 Sch=sw[2]
set_property -dict { PACKAGE_PIN V4    IOSTANDARD LVCMOS33 } [get_ports { sliders[3] }]; #IO_L21N_T3_DQS_13 Sch=sw[3]
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { sliders[4] }]; #IO_L2N_T0_13 Sch=sw[4]
set_property -dict { PACKAGE_PIN U9    IOSTANDARD LVCMOS33 } [get_ports { sliders[5] }]; #IO_L6N_T0_VREF_13 Sch=sw[5]
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { user_guess }]; #IO_L3N_T0_DQS_13 Sch=sw[6]
set_property -dict { PACKAGE_PIN V9    IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L1N_T0_13 Sch=sw[7]
...
set_property PACKAGE_PIN Y9 [get_ports {number_leds[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {number_leds[0]}]
set_property PACKAGE_PIN Y8 [get_ports {number_leds[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {number_leds[1]}]
set_property PACKAGE_PIN V7 [get_ports {number_leds[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {number_leds[2]}]
set_property PACKAGE_PIN W7 [get_ports {number_leds[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {number_leds[3]}]
set_property PACKAGE_PIN T6 [get_ports {sliders[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sliders[0]}]
set_property PACKAGE_PIN U5 [get_ports {sliders[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sliders[1]}]
set_property PACKAGE_PIN T4 [get_ports {sliders[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sliders[2]}]
set_property PACKAGE_PIN V4 [get_ports {sliders[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sliders[3]}]
set_property PACKAGE_PIN W8 [get_ports {sliders[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sliders[4]}]
set_property PACKAGE_PIN U9 [get_ports {sliders[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {sliders[5]}]
set_property PACKAGE_PIN L18 [get_ports clk]
set_property IOSTANDARD LVCMOS33 [get_ports clk]
set_property PACKAGE_PIN V10 [get_ports guess_result_led]
set_property IOSTANDARD LVCMOS33 [get_ports guess_result_led]
set_property PACKAGE_PIN W12 [get_ports prime_result_led]
set_property IOSTANDARD LVCMOS33 [get_ports prime_result_led]
set_property PACKAGE_PIN W11 [get_ports user_guess_led]
set_property IOSTANDARD LVCMOS33 [get_ports user_guess_led]
set_property PACKAGE_PIN V9 [get_ports user_guess]
set_property PACKAGE_PIN W10 [get_ports reset]
set_property IOSTANDARD LVCMOS33 [get_ports reset]
set_property IOSTANDARD LVCMOS33 [get_ports user_guess]
